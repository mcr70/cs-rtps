...
namespace rtps
{
	...
	public class Gap : SubMessage
	{
		...
		public Gap(EntityId readerId, EntityId writerId, long gapStart, long gapEnd) : base(new SubMessageHeader(KIND))
		{
		...
		public virtual long GapStart
		{
			get
			{
                return gapStart.asLong();
			}
		}
		...
		public virtual SequenceNumberSet GapList
		{
			get
			{
				return gapList;
