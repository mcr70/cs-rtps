...
namespace rtps
{
	...
	public class Header
	{
		...
		internal Header(RTPSByteBuffer bb)
		{
			...
			{
				throw new IllegalMessageException("Illegal message header start bytes: " + string.Join(",", hdrStart) + ", expected " + string.Join(",", HDR_START));
			}
		...
		public virtual GuidPrefix GuidPrefix
		{
			get
			{
				return guidPrefix;
		...
		public virtual VendorId VendorId
		{
			get
			{
				return vendorId;
		...
		public virtual ProtocolVersion Version
		{
			get
			{
				return version;
	...
	public abstract class SubMessage
	{
		...
		public virtual SubMessageHeader Header
		{
			get
			{
				return header;
	...
	public class SubMessageHeader
	{
		...
		/// </summary>
		private const sbyte DEFAULT_ENDIANNESS_FLAG = 0x00;

		internal sbyte kind;
		internal sbyte flags; // 8 flags
		internal int submessageLength; // ushort
		...
		public SubMessageHeader(int kind) : this(kind, DEFAULT_ENDIANNESS_FLAG)
		{
		}
		...
		/// </summary>
		/// <returns> kind </returns>
		public virtual sbyte SubMessageKind
		{
			get
			{
				return kind;
