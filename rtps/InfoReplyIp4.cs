namespace rtps
{
	...
	public class InfoReplyIp4 : SubMessage
	{
		...
		public InfoReplyIp4(LocatorUDPv4_t unicastLocator, LocatorUDPv4_t multicastLocator) : base(new SubMessageHeader(KIND))
		{
		...
		public virtual LocatorUDPv4_t UnicastLocator
		{
			get
			{
		...
		public virtual LocatorUDPv4_t MulticastLocator
		{
			get
			{
