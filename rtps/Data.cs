...
namespace rtps
{
	...
	public class Data : SubMessage
	{
		...
		public Data(EntityId readerId, EntityId writerId, long seqNum, ParameterList inlineQosParams, DataEncapsulation dEnc) : base(new SubMessageHeader(KIND))
		{
		...
		public virtual ParameterList InlineQos
		{
			get
			{
		...
		public virtual long WriterSequenceNumber
		{
			get
			{
				return writerSN.asLong();
			}
		}
		...
		public virtual DataEncapsulation DataEncapsulation
		{
			get
			{
